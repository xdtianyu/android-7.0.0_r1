...
*
* @par Description
*  The current routine initializes the function pointers based on architecture
*
* @param[in] ps_ctxt
*  Context pointer
*
...
{
    ps_ctxt->pf_sad_8x4 = icv_sad_8x4_ssse3;
    ps_ctxt->pf_variance_8x4 = icv_variance_8x4_ssse3;
    ps_ctxt->pf_spatial_filter = ideint_spatial_filter_ssse3;
    ps_ctxt->pf_cac_8x8 = ideint_cac_8x8_ssse3;
    return;
}
