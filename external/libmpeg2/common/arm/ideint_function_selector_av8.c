...
*
* @brief
*  Initialize function pointers based on the architecture
*
* @par Description
*  Initialize function pointers based on the architecture
*
...
{
    ps_ctxt->pf_sad_8x4 = icv_sad_8x4_av8;
    ps_ctxt->pf_variance_8x4 = icv_variance_8x4_av8;
    ps_ctxt->pf_spatial_filter = ideint_spatial_filter_av8;
    ps_ctxt->pf_cac_8x8 = ideint_cac_8x8_av8;
    return;
}
