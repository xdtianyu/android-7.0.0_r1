...
{
    ps_ctxt->pf_sad_8x4 = icv_sad_8x4_a9;
    ps_ctxt->pf_variance_8x4 = icv_variance_8x4_a9;
    ps_ctxt->pf_spatial_filter = ideint_spatial_filter_a9;
    ps_ctxt->pf_cac_8x8 = ideint_cac_8x8_a9;
    return;
}
