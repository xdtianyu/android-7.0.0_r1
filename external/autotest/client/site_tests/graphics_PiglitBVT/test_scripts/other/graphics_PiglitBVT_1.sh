...
run_test "asmparsertest/ARBfp1.0/reserved_words-01.txt" 0.0 "bin/asmparsertest ARBfp1.0 tests/asmparsertest/shaders/ARBfp1.0/reserved_words-01.txt -fbo -auto"
...
run_test "glean/fragProg1-COS test 2" 0.0 "bin/glean -o -v -v -v -t +fragProg1 --quick"
...
run_test "glean/fragProg1-SIN test 2" 0.0 "bin/glean -o -v -v -v -t +fragProg1 --quick"
...
run_test "glx/glx-copy-sub-buffer samples=2" 0.0 "bin/glx-copy-sub-buffer -samples=2 -auto"
run_test "glx/glx-copy-sub-buffer samples=4" 0.0 "bin/glx-copy-sub-buffer -samples=4 -auto"
