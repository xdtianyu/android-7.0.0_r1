...
UINT16 Load_Out_Marshal(Load_Out* source,
...
TPM_RC Load_In_Unmarshal(Load_In* target,
  ...
  result = TPM2B_PRIVATE_Unmarshal(&target->inPrivate, buffer, size);
...
TPM_RC Exec_Load(TPMI_ST_COMMAND_TAG tag,
  ...
  *response_parameter_buffer_size = 0;
  ...
  result = Load_In_Unmarshal(&in, request_handles, request_parameter_buffer,
...
// Marshal output structure to global response buffer.
  ...
  bytes_marshalled =
      Load_Out_Marshal(&out, tag, &response_buffer, &response_buffer_size);
