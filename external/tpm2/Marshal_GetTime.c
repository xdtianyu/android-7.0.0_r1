...
UINT16 GetTime_Out_Marshal(GetTime_Out* source,
  ...
  total_size += TPM2B_ATTEST_Marshal(&source->timeInfo, buffer, size);
...
TPM_RC Exec_GetTime(TPMI_ST_COMMAND_TAG tag,
  ...
  *response_parameter_buffer_size = 0;
  ...
  result = GetTime_In_Unmarshal(&in, request_handles, request_parameter_buffer,
...
// Marshal output structure to global response buffer.
  ...
  bytes_marshalled =
      GetTime_Out_Marshal(&out, tag, &response_buffer, &response_buffer_size);
