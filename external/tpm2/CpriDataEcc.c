...
const TPM2B_24_BYTE_VALUE NIST_P192_p = { .t = {24,
       {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
        0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFE,
        0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF}}};
const TPM2B_24_BYTE_VALUE NIST_P192_a = { .t = {24,
       {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
        0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFE,
        0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFC}}};
const TPM2B_24_BYTE_VALUE NIST_P192_b = { .t = {24,
       {0x64, 0x21, 0x05, 0x19, 0xE5, 0x9C, 0x80, 0xE7,
        0x0F, 0xA7, 0xE9, 0xAB, 0x72, 0x24, 0x30, 0x49,
        0xFE, 0xB8, 0xDE, 0xEC, 0xC1, 0x46, 0xB9, 0xB1}}};
const TPM2B_24_BYTE_VALUE NIST_P192_gX = { .t = {24,
       {0x18, 0x8D, 0xA8, 0x0E, 0xB0, 0x30, 0x90, 0xF6,
        0x7C, 0xBF, 0x20, 0xEB, 0x43, 0xA1, 0x88, 0x00,
        0xF4, 0xFF, 0x0A, 0xFD, 0x82, 0xFF, 0x10, 0x12}}};
const TPM2B_24_BYTE_VALUE NIST_P192_gY = { .t = {24,
       {0x07, 0x19, 0x2B, 0x95, 0xFFC, 0x8D, 0xA7, 0x86,
        0x31, 0x01, 0x1ED, 0x6B, 0x24, 0xCD, 0xD5, 0x73,
        0xF9, 0x77, 0xA1, 0x1E, 0x79, 0x48, 0x11}}};
const TPM2B_24_BYTE_VALUE NIST_P192_n = { .t = {24,
       {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
        0xFF, 0xFF, 0xFF, 0xFF, 0x99, 0xDE, 0xF8, 0x36,
        0x14, 0x6B, 0xC9, 0xB1, 0xB4, 0xD2, 0x28, 0x31}}};
const TPM2B_1_BYTE_VALUE NIST_P192_h = { .t = {1,{1}}};
...
const TPM2B_28_BYTE_VALUE NIST_P224_p = { .t = {28,
       {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
        0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x01}}};
const TPM2B_28_BYTE_VALUE NIST_P224_a = { .t = {28,
       {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
        0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFE,
        0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
        0xFF, 0xFF, 0xFF, 0xFE}}};
const TPM2B_28_BYTE_VALUE NIST_P224_b = { .t = {28,
       {0xB4, 0x05, 0x0A, 0x85, 0x0C, 0x04, 0xB3, 0xAB,
        0xF5, 0x41, 0x32, 0x56, 0x50, 0x44, 0xB0, 0xB7,
        0xD7, 0xBF, 0xD8, 0xBA, 0x27, 0x0B, 0x39, 0x43,
        0x23, 0x55, 0xFF, 0xB4}}};
const TPM2B_28_BYTE_VALUE NIST_P224_gX = { .t = {28,
       {0xB7, 0x0E, 0x0C, 0xBD, 0x6B, 0xB4, 0xBF, 0x7F,
        0x32, 0x13, 0x90, 0xB9, 0x4A, 0x03, 0xC1, 0xD3,
        0x56, 0xC2, 0x11, 0x22, 0x34, 0x32, 0x80, 0xD6,
        0x11, 0x5C, 0x1D, 0x21}}};
const TPM2B_28_BYTE_VALUE NIST_P224_gY = { .t = {28,
       {0xBD, 0x37, 0x63, 0x88, 0xB5, 0xF7, 0x23, 0xFB,
        0x4C, 0x22, 0xDF, 0xE6, 0xCD, 0x43, 0x75, 0xA0,
        0x5A, 0x07, 0x47, 0x64, 0x44, 0xD5, 0x81, 0x99,
        0x85, 0x00, 0x7E, 0x34}}};
const TPM2B_28_BYTE_VALUE NIST_P224_n = { .t = {28,
       {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
        0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x16, 0xA2,
        0xE0, 0xB8, 0xF0, 0x3E, 0x13, 0xDD, 0x29, 0x45,
        0x5C, 0x5C, 0x2A, 0x3D}}};
const TPM2B_1_BYTE_VALUE NIST_P224_h = { .t = {1,{1}}};
...
const TPM2B_32_BYTE_VALUE NIST_P256_p = { .t = {32,
       {0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x01,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0xFF,
        0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF}}};
const TPM2B_32_BYTE_VALUE NIST_P256_a = { .t = {32,
       {0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x01,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0xFF,
        0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFC}}};
const TPM2B_32_BYTE_VALUE NIST_P256_b = { .t = {32,
       {0x5A, 0xC6, 0x35, 0xD8, 0xAA, 0x3A, 0x93, 0xE7,
        0xB3, 0xEB, 0xBD, 0x55, 0x76, 0x98, 0x86, 0xBC,
        0x65, 0x1D, 0x06, 0xB0, 0xCC, 0x53, 0xB0, 0xF6,
        0x3B, 0xCE, 0x3C, 0x3E, 0x27, 0xD2, 0x60, 0x4B}}};
const TPM2B_32_BYTE_VALUE NIST_P256_gX = { .t = {32,
       {0x6B, 0x17, 0xD1, 0xF2, 0xE1, 0x2C, 0x42, 0x47,
        0xF8, 0xBC, 0xE6, 0xE5, 0x63, 0xA4, 0x40, 0xF2,
        0x77, 0x03, 0x7D, 0x81, 0x2D, 0xEB, 0x33, 0xA0,
        0xF4, 0xA1, 0x39, 0x45, 0xD8, 0x98, 0xC2, 0x96}}};
const TPM2B_32_BYTE_VALUE NIST_P256_gY = { .t = {32,
       {0x4F, 0xE3, 0x42, 0xE2, 0xFE, 0x1A, 0x7F, 0x9B,
        0x8E, 0xE7, 0xEB, 0x4A, 0x7C, 0x0F, 0x9E, 0x16,
        0x2B, 0xCE, 0x33, 0x57, 0x6B, 0x31, 0x5E, 0xCE,
        0xCB, 0xB6, 0x40, 0x68, 0x37, 0xBF, 0x51, 0xF5}}};
const TPM2B_32_BYTE_VALUE NIST_P256_n = { .t = {32,
       {0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00,
        0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
        0xBC, 0xE6, 0xFA, 0xAD, 0xA7, 0x17, 0x9E, 0x84,
        0xF3, 0xB9, 0xCA, 0xC2, 0xFC, 0x63, 0x25, 0x51}}};
const TPM2B_1_BYTE_VALUE NIST_P256_h = { .t = {1,{1}}};
...
const TPM2B_48_BYTE_VALUE NIST_P384_p = { .t = {48,
       {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
        0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
        0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
        0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFE,
        0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0xFF}}};
const TPM2B_48_BYTE_VALUE NIST_P384_a = { .t = {48,
       {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
        0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
        0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
        0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFE,
...
const TPM2B_48_BYTE_VALUE NIST_P384_b = { .t = {48,
...
const TPM2B_48_BYTE_VALUE NIST_P384_gX = { .t = {48,
...
const TPM2B_48_BYTE_VALUE NIST_P384_gY = { .t = {48,
...
const TPM2B_48_BYTE_VALUE NIST_P384_n = { .t = {48,
       {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
        0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
        0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
...
const TPM2B_1_BYTE_VALUE NIST_P384_h = { .t = {1,{1}}};
...
const TPM2B_66_BYTE_VALUE NIST_P521_p = { .t = {66,
       {0x01, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
        ...
        0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
        0xFF, 0xFF}}};
const TPM2B_66_BYTE_VALUE NIST_P521_a = { .t = {66,
       {0x01, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
        0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
        0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
        0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
        ...
        0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
        0xFF, 0xFC}}};
const TPM2B_66_BYTE_VALUE NIST_P521_b = { .t = {66,
       {0x00, 0x51, 0x95, 0x3E, 0xB9, 0x61, 0x8E, 0x1C,
        ...
        0x3F, 0x00}}};
const TPM2B_66_BYTE_VALUE NIST_P521_gX = { .t = {66,
       {0x00, 0xC6, 0x85, 0x8E, 0x06, 0xB7, 0x04, 0x04,
        ...
        0xBD, 0x66}}};
const TPM2B_66_BYTE_VALUE NIST_P521_gY = { .t = {66,
       {0x01, 0x18, 0x39, 0x29, 0x6A, 0x78, 0x9A, 0x3B,
        ...
        0x66, 0x50}}};
const TPM2B_66_BYTE_VALUE NIST_P521_n = { .t = {66,
       {0x01, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
        0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
        0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
        0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
        ...
        0x64, 0x09}}};
const TPM2B_1_BYTE_VALUE NIST_P521_h = { .t = {1,{1}}};
...
const TPM2B_32_BYTE_VALUE BN_P256_p = { .t = {32,
...
const TPM2B_1_BYTE_VALUE BN_P256_a = { .t = {1,{0}}};
const TPM2B_1_BYTE_VALUE BN_P256_b = { .t = {1,{3}}};
const TPM2B_1_BYTE_VALUE BN_P256_gX = { .t = {1,{1}}};
const TPM2B_1_BYTE_VALUE BN_P256_gY = { .t = {1,{2}}};;
const TPM2B_32_BYTE_VALUE BN_P256_n = { .t = {32,
       {0xFF, 0XFF, 0XFF, 0XFF, 0XFF, 0XFC, 0XF0, 0XCD,
        0X46, 0XE5, 0XF2, 0X5E, 0XEE, 0X71, 0XA4, 0X9E,
        0X0C, 0XDC, 0X65, 0XFB, 0X12, 0X99, 0X92, 0X1A,
        0XF6, 0X2D, 0X53, 0X6C, 0XD1, 0X0B, 0X50, 0X0D}}};
const TPM2B_1_BYTE_VALUE BN_P256_h = { .t = {1,{1}}};
...
const TPM2B_80_BYTE_VALUE BN_P638_p = { .t = {80,
...
const TPM2B_1_BYTE_VALUE BN_P638_a = { .t = {1,{0}}};
const TPM2B_2_BYTE_VALUE BN_P638_b = { .t = {2,{0x01,0x01}}};
const TPM2B_80_BYTE_VALUE BN_P638_gX = { .t = {80,
       {0x23, 0xFF, 0xFF, 0xFD, 0xC0, 0x00, 0x00, 0x0D,
        0x7F, 0xFF, 0xFF, 0xB8, 0x00, 0x00, 0x01, 0xD3,
        0xFF, 0xFF, 0xF9, 0x42, 0xD0, 0x00, 0x16, 0x5E,
        0x3F, 0xFF, 0x94, 0x87, 0x00, 0x00, 0xD5, 0x2F,
...
const TPM2B_1_BYTE_VALUE BN_P638_gY = { .t = {1,{0x10}}};
const TPM2B_80_BYTE_VALUE BN_P638_n = { .t = {80,
       {0x23, 0xFF, 0xFF, 0xFD, 0xC0, 0x00, 0x00, 0x0D,
        0x7F, 0xFF, 0xFF, 0xB8, 0x00, 0x00, 0x01, 0xD3,
        0xFF, 0xFF, 0xF9, 0x42, 0xD0, 0x00, 0x16, 0x5E,
        0x3F, 0xFF, 0x94, 0x87, 0x00, 0x00, 0xD5, 0x2F,
...
const TPM2B_1_BYTE_VALUE BN_P638_h = { .t = {1,{1}}};
...
const TPM2B_32_BYTE_VALUE SM2_P256_p = { .t = {32,
       {0xFF, 0xFF, 0xFF, 0xFE, 0xFF, 0xFF, 0xFF, 0xFF,
        0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
        0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00,
        0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF}}};
const TPM2B_32_BYTE_VALUE SM2_P256_a = { .t = {32,
       {0xFF, 0xFF, 0xFF, 0xFE, 0xFF, 0xFF, 0xFF, 0xFF,
        0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
        0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00,
        0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFC}}};
const TPM2B_32_BYTE_VALUE SM2_P256_b = { .t = {32,
       {0x28, 0xE9, 0xFA, 0x9E, 0x9D, 0x9F, 0x5E, 0x34,
        0x4D, 0x5A, 0x9E, 0x4B, 0xCF, 0x65, 0x09, 0xA7,
        0xF3, 0x97, 0x89, 0xF5, 0x15, 0xAB, 0x8F, 0x92,
        0xDD, 0xBC, 0xBD, 0x41, 0x4D, 0x94, 0x0E, 0x93}}};
const TPM2B_32_BYTE_VALUE SM2_P256_gX = { .t = {32,
       {0x32, 0xC4, 0xAE, 0x2C, 0x1F, 0x19, 0x81, 0x19,
        0x5F, 0x99, 0x04, 0x46, 0x6A, 0x39, 0xC9, 0x94,
        0x8F, 0xE3, 0x0B, 0xBF, 0xF2, 0x66, 0x0B, 0xE1,
        0x71, 0x5A, 0x45, 0x89, 0x33, 0x4C, 0x74, 0xC7}}};
const TPM2B_32_BYTE_VALUE SM2_P256_gY = { .t = {32,
       {0xBC, 0x37, 0x36, 0xA2, 0xF4, 0xF6, 0x77, 0x9C,
        0x59, 0xBD, 0xCE, 0xE3, 0x6B, 0x69, 0x21, 0x53,
        0xD0, 0xA9, 0x87, 0x7C, 0xC6, 0x2A, 0x47, 0x40,
        0x02, 0xDF, 0x32, 0xE5, 0x21, 0x39, 0xF0, 0xA0}}};
const TPM2B_32_BYTE_VALUE SM2_P256_n = { .t = {32,
       {0xFF, 0xFF, 0xFF, 0xFE, 0xFF, 0xFF, 0xFF, 0xFF,
        0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
        0x72, 0x03, 0xDF, 0x6B, 0x21, 0xC6, 0x05, 0x2B,
        0x53, 0xBB, 0xF4, 0x09, 0x39, 0xD5, 0x41, 0x23}}};
const TPM2B_1_BYTE_VALUE SM2_P256_h = { .t = {1,{1}}};
