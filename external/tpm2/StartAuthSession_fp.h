...
#ifndef TPM2_STARTAUTHSESSION_FP_H_
#define TPM2_STARTAUTHSESSION_FP_H_
...
// Executes StartAuthSession with request handles and parameters from
// |in| and computes response handles and parameters to |out|.
TPM_RC TPM2_StartAuthSession(StartAuthSession_In* in,
                             StartAuthSession_Out* out);

// Initializes handle fields in |target| from |request_handles|. Unmarshals
// parameter fields in |target| from |buffer|.
TPM_RC StartAuthSession_In_Unmarshal(StartAuthSession_In* target,
...
UINT16 StartAuthSession_Out_Marshal(StartAuthSession_Out* source,
...
#endif  // TPM2_STARTAUTHSESSION_FP_H
