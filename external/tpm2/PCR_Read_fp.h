...
#ifndef TPM2_PCR_READ_FP_H_
#define TPM2_PCR_READ_FP_H_
...
// Executes PCR_Read with request handles and parameters from
...
TPM_RC PCR_Read_In_Unmarshal(PCR_Read_In* target,
...
UINT16 PCR_Read_Out_Marshal(PCR_Read_Out* source,
