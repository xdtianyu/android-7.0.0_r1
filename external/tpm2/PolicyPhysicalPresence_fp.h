...
#ifndef TPM2_POLICYPHYSICALPRESENCE_FP_H_
#define TPM2_POLICYPHYSICALPRESENCE_FP_H_
...
TPM_RC Exec_PolicyPhysicalPresence(TPMI_ST_COMMAND_TAG tag,
...
#endif  // TPM2_POLICYPHYSICALPRESENCE_FP_H
