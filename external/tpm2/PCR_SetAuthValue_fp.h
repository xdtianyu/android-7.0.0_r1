...
#ifndef TPM2_PCR_SETAUTHVALUE_FP_H_
#define TPM2_PCR_SETAUTHVALUE_FP_H_
...
// Executes PCR_SetAuthValue with request handles and parameters from |in|.
...
#endif  // TPM2_PCR_SETAUTHVALUE_FP_H
