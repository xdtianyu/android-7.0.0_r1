...
TPM_RC PCR_Extend_In_Unmarshal(PCR_Extend_In* target,
  ...
  result = TPML_DIGEST_VALUES_Unmarshal(&target->digests, buffer, size);
...
TPM_RC Exec_PCR_Extend(TPMI_ST_COMMAND_TAG tag,
  ...
  *response_parameter_buffer_size = 0;
  ...
  result =
      PCR_Extend_In_Unmarshal(&in, request_handles, request_parameter_buffer,
