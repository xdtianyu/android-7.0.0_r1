...
#ifndef TPM2_CHANGEEPS_FP_H_
#define TPM2_CHANGEEPS_FP_H_

#include "tpm_generated.h"

typedef struct { TPMI_RH_PLATFORM authHandle; } ChangeEPS_In;

// Executes ChangeEPS with request handles and parameters from |in|.
