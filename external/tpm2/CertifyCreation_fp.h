...
#ifndef TPM2_CERTIFYCREATION_FP_H_
#define TPM2_CERTIFYCREATION_FP_H_
...
// Executes CertifyCreation with request handles and parameters from
...
TPM_RC CertifyCreation_In_Unmarshal(CertifyCreation_In* target,
...
UINT16 CertifyCreation_Out_Marshal(CertifyCreation_Out* source,
...
TPM_RC Exec_CertifyCreation(TPMI_ST_COMMAND_TAG tag,
...
#endif  // TPM2_CERTIFYCREATION_FP_H
