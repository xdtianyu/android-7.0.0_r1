...
#ifndef TPM2_CONTEXTSAVE_FP_H_
#define TPM2_CONTEXTSAVE_FP_H_

#include "tpm_generated.h"

typedef struct { TPMI_DH_CONTEXT saveHandle; } ContextSave_In;

typedef struct { TPMS_CONTEXT context; } ContextSave_Out;

// Executes ContextSave with request handles and parameters from
...
TPM_RC ContextSave_In_Unmarshal(ContextSave_In* target,
...
UINT16 ContextSave_Out_Marshal(ContextSave_Out* source,
...
TPM_RC Exec_ContextSave(TPMI_ST_COMMAND_TAG tag,
