 ...
 *
 * @author Chris Mair
 * @version $Revision: 137 $ - $Date: 2008-10-24 21:39:43 -0400 (Fri, 24 Oct 2008) $
 */
public class RnfrCommandHandler extends AbstractFakeCommandHandler {
    ...
    protected void handle(Command command, Session session) {
        ...
        verifyFileSystemCondition(getFileSystem().isFile(fromPath), fromPath, "filesystem.isNotAFile");
