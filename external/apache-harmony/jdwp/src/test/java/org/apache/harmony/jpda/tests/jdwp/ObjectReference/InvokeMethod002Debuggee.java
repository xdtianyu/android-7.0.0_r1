...
public class InvokeMethod002Debuggee extends SyncDebuggee {
    ...
    public void run() {
        ...
        synchronizer.receiveMessageWithoutException("org.apache.harmony.jpda.tests.jdwp.ObjectReference.InvokeMethod002Debuggee(#1)");
        execMethod();
        synchronizer.receiveMessageWithoutException("org.apache.harmony.jpda.tests.jdwp.ObjectReference.InvokeMethod002Debuggee(#2)");
    }

    public static void main(String[] args) {
        runDebuggee(InvokeMethod002Debuggee.class);
    }
}
