 ...
 *******************************************************************************
 */
package android.icu.samples.text.datetimepatterngenerator;
// IGNORED_INCLUDE(getBestPatternExample)
...
// IGNORED_INCLUDE(getBestPatternExample)
/**
 * android.icu.text.DateTimePatternGenerator Sample Code
 */
public class DateTimePatternGeneratorSample {
    ...
    public static void   getBestPatternExample() {
        ...
        System.out.println("========================================================================");
     // BEGIN_INCLUDE(getBestPatternExample)
        ...
        **************************************************************************************************************/
         ...
         ************************************************************************************************************
         ...
         MMMMd               October 13                         13 octobre                         10月13日 
         ************************************************************************************************************/
// END_INCLUDE(getBestPatternExample)
}
    ...
    public static void addPatternExample() {
        ...
        System.out.println("========================================================================");
    // BEGIN_INCLUDE(addPatternExample)
        Date date= new GregorianCalendar(1999,9,13,23,58,59).getTime();
    ...
    public static void replaceFieldTypesExample() {
        ...
        System.out.println("========================================================================");
    // BEGIN_INCLUDE(replaceFieldTypesExample)
        Date date= new GregorianCalendar(1999,9,13,23,58,59).getTime();
