...
public class ICUPropertyFactory extends UnicodeProperty.Factory {
    ...
    static class ICUProperty extends UnicodeProperty {
        ...
        /* (non-Javadoc)
         * @see android.icu.dev.test.util.UnicodePropertySource#getPropertyType()
         */
         ...
         * (non-Javadoc)
         * 
         * @see android.icu.dev.test.util.UnicodeProperty#getVersion()
         */
...
//        NFKD = UProperty.STRING_LIMIT+3
     ...
     * (non-Javadoc)
     * 
     * @see android.icu.dev.test.util.UnicodePropertySource#getProperty(java.lang.String)
     */
